    		...
    		<div class="page-wrap">
 				<div class="clr-fix">
					...
					<div class="buttons">
					  ...
					  <a href="${path2 }/book/update.do?no=${book.no }" class="button is-warning">도서 정보수정</a>
					  <a href="${path2 }/book/delBook.do?no=${book.no }" class="button is-danger is-dark">도서 정보삭제</a>
					  </c:if>
