		                ...
		                <div class="table_form_wrap">
		                    <table class="table_form">
		                        ...
		                        <tr>
		                            ...
		                            <td>
		                                <input type="text" name="addr1" id="addr1" class="input" value="${cus.addr1 }"><br>
		                                <input type="text" name="addr2" id="addr2" class="input" value="${cus.addr2 }"><br>
