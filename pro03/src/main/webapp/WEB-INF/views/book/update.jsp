    		...
    		<div class="page-wrap">
	    		<div class="clr-fix">
					...
					<form action="${path2 }/book/updatePro.do" method="post" enctype="multipart/form-data">
						<table class="table">
							<tbody>
								<tr>
									...
									<td>
										<input type="text" name="no" id="no" value="${book.no }" readonly>
									</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td>
										...
										<br>현재 이미지: <img src="${path2}/resources/upload/${book.img1}" width="100">
									</td>
								</tr>
								<tr>
									...
									<td>
										...
										<br>현재 이미지: <img src="${path2}/resources/upload/${book.img2}" width="100">
									</td>
								</tr>
								<tr>
									...
									<td>
										...
										<br>현재 이미지: <img src="${path2}/resources/upload/${book.img3}" width="100">
									</td>
								</tr>
							</tbody>
						</table>
						<hr>
						<div class="buttons">
						  <button type="submit" class="button is-danger">도서 정보수정</button>
