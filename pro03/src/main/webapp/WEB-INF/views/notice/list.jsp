...
<head>
	...
	td#list_item { text-align:center; }
	</style>
</head>
<body>
<!-- 헤더 부분 인클루드 -->
    		...
    		<div class="page-wrap">
	    		<div class="clr-fix">
					...
					<table class="table" id="tb1">
						<thead>
							<tr>
								<th class="item1" id="item">번호</th>
								<th class="item2">제목</th>
								<th class="item3" id="item">작성일</th>
								<th class="item4" id="item">조회수</th>
							</tr>
						</thead>
						<tbody>
							<c:if test="${not empty list }">
								...
								<tr>
									<td id="list_item">${dto.no }</td>
									<td>
										<a href="${path2 }/notice/detail.do?no=${dto.no }">${dto.title }</a>
									</td>
									<td id="list_item">${dto.resdate }</td>
									<td id="list_item">${dto.visited }</td>
								</tr>
								</c:forEach>
							</c:if>
